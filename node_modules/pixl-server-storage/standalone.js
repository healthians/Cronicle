{
	...
	"email_from": "cronicle@echl.co.in",
	"smtp_hostname": "smtp.email.ap-mumbai-1.oci.oraclecloud.com",
	"smtp_port": 587,
	"mail_options": {
		"secure": false,
		"auth": { "user": "ocid1.user.oc1..aaaaaaaasz6pbvimypcfo5f3e7ltxtqj7mpzltb7dbsk2ezcmjsyh4bwtjua@ocid1.tenancy.oc1..aaaaaaaay2jwgqnaekevg7fflapecyclit75bkyncob6icaevtmdp5xkpa4a.z4.com", "pass": "Y)YASt}.TH{!5m$fi8Yc" },
	...
	"Storage": {
		...
		"AWS": {
			"accessKeyId": "279b662ae8083a8cac0ae65a754d31000a2cc0ce", 
			"secretAccessKey": "JFWEa8Mv3svNu2xpKnIlM/vHDKBRVyd8dZTNMkwd/3o=", 
			"region": "us-east-1",
            ...
            "endpoint": "https://bmqcff61em7x.compat.objectstorage.ap-mumbai-1.oraclecloud.com"
		},
		"S3": {
			"keyPrefix": "hl-cronicle/cronicle-crn001",
			"fileExtensions": true,
			"params": {
				"Bucket": "bmqcff61em7x"
			}
